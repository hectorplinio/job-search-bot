"""Almacen de cookies de sesion en disco.

Las cookies caducan. En vez de que las pegues a mano en .env cada vez,
`jobbot login` las refresca desde un navegador real y las deja aqui, con la
fecha de caducidad que diga el propio portal.

El fichero es tan sensible como tu contrasena: vive en `data/`, que esta en
.gitignore, y nunca se imprime entero por pantalla ni por los logs.
"""
...
class StoredCookie:
    ...
    def describe(self) -> str:
        """Resumen seguro de imprimir: nunca incluye el valor."""
...
class CookieStore:
    ...
    def save(self, source: str, value: str, expires_at: datetime | None = None) -> StoredCookie:
        ...
        # En Windows los permisos POSIX no aplican, pero en Linux/macOS si.
